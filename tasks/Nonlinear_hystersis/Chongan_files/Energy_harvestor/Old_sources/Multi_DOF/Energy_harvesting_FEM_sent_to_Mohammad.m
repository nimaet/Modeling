...
% Solve the system
[T, X] = ode45(@(T, x) odefun(T, x, Theta, Fb, Omega_f, Fv, Omega_f2, zeta, Omega_t), Tspan_simple, x0);
figure(44)
hold on
...
% set(gca,'fontsize',14)
% ylim([-5 30])
function dxdt = odefun(T, x, Theta, Fb, Omega_f, Fv, Omega_f2, zeta, Omega_t)
