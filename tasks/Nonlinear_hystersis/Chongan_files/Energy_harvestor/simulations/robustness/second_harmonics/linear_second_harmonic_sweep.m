...
E1_linear(i_omega_secondary) = trapz(T,P1);
end
hold on
h1 = plot((1:1000)/omega1,E1);
h2 = plot((1:1000)/omega1,E1_linear);
xlabel(['Normalized Frequency'])
ylabel(['Normalized Energy Measure'])
legend([h1 h2],'Nonlinear','Linear')
set(gca,'fontsize',16)
xlim([0 1.5])